...
@section('content')
    <div class="container-fluid ">
        ...
        <a href="{{ route('absensiSiswa', ['id_pertemuan' => $id_pertemuan]) }}" class="btn btn-warning mb-3">Siswa Belum Absen</a>
            ...
            <div class="col-12 d-flex align-items-stretch ">
                <div class="card w-100 ">
                    <div class="card-body p-4">
                        ...
                        <h6 class="card-subtitle fw-light mb-4">NB: siswa akan tampil hanya ketika absen telah diterima atau diabsenkan oleh pelatih</h6>
