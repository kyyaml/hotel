...
<div class="row">
    ...
    <div class="col-12 col-md-6 col-lg-4">
        <div class="owl-item active">
            <div class="item">
                <div class="card border-0 zoom-in {{$validasi === 0 ? 'bg-success-subtle' : 'bg-danger-subtle'}} shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            @if($validasi !== 0)
                                <img src="https://cdn-icons-png.flaticon.com/512/5442/5442020.png" width="50" height="50" class="mb-3" alt="">
                                <p class="fw-semibold fs-3 text-danger mb-1">Presensi Belum Tervalidasi</p>
                                <h5 class="fw-semibold text-danger mb-0">{{$validasi}}</h5>
                            @endif
                            @if($validasi === 0)
                                <img src="https://cdn-icons-png.flaticon.com/512/8215/8215539.png" width="50" height="50" class="mb-3" alt="">
