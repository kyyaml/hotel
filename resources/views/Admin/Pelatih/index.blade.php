    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12 col-lg-4 col-md-5 ">
                <form action="{{ route('pelatih.search') }}" method="GET">
                    <div class="input-group mb-3">
                        <input type="search" name="searchPelatih" placeholder="cari nama pelatih... " id="form1"
                                    ...
                                    @if (count($pelatih) > 0)
                                        @foreach ($pelatih as $k => $v)
                                            <tr>
                                                ...
                                                <td class="border-bottom-0">
                                                    <a href="{{ route('pelatih.edit', $v->id_pelatih) }}"
                                                        class="text-muted"><u>
