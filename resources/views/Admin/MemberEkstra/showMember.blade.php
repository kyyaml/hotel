...
@section('content')
    <a href="{{ route('member-ekstra.create-form', $ekstrakurikuler->id_ekstra) }}" class="btn btn-primary mb-3">Tambah Member</a>
        ...
        <div class="col-12 d-flex align-items-stretch ">
            <div class="card w-100">
                <div class="card-body p-4">
                    <h5 class="card-title fw-semibold mb-4">Tabel Anggota Ekstra {{ $ekstrakurikuler->nama }}</h5>
                                ...
                                @foreach ($siswa as $k => $v)
                                    <tr>
                                        ...
                                        <td class="border-bottom-0">
                                            <form action="{{ route('member-ekstra.destroyData', ['nis' => $v->nis, 'id_ekstra' => $ekstrakurikuler->id_ekstra]) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
