    ...
    <div class="container-fluid ">
        <div class="row">
            <div class="col-12 col-lg-4 col-md-5 ">
                <form action="<?php echo e(route('absensi.searchPertemuan')); ?>" method="GET">
                                ...
                                <?php if(count($pertemuan) > 0): ?>
                                    <?php $__currentLoopData = $pertemuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="border-bottom-0">
                                                <a href="<?php echo e(route('showKehadiran', $v->id_pertemuan)); ?>"
                                                    class="text-muted"><u>
                                                        <p class="mb-0 fw-normal ">Lihat Kehadiran</p>
                                                    </u></a>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\final_projek\ekstra\resources\views/Admin/Absensi/index.blade.php ENDPATH**/ ?>